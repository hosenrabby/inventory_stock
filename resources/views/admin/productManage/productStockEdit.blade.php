                                    ...
                                    <div class="basic-form">
                                        <form action="{{ url('authorized/product-stock/'.$findData->id) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="productName" value="{{ $findData->productName }}">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <select class="form-control" name="catagoryID">
                                                        ...
                                                        <option value="{{ $catagory->catagoryID }}"
                                                            @if ($findData->catagoryID == $catagory->id) selected @endif>{{ $catagory->categoryName }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col">
                                                    ...
                                                    <select class="form-control" name="subcatagoryID">
                                                        ...
                                                        <option value="{{ $subcatagory->subCatagoryID }}"
                                                            @if ($findData->subCatagoryID == $subcatagory->subCatagoryID ) selected @endif>{{ $subcatagory->subCategoryName }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col">
                                                    ...
                                                    <input type="number" class="form-control" name="prodRate" placeholder="Product Rate" value="{{ $findData->prodRate }}">
                                                </div>
                                                <div class="form-group col">
                                                    <label>Stock Balance</label>
                                                    <input type="number" class="form-control" name="stockBalance" placeholder="Stock Balance" value="{{ $findData->stockBalance }}">
                                                </div>
                                            </div>
