                                    ...
                                    <div class="basic-form">
                                        <form action="{{ route('customer.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('customerName')
                                                is-invalid
                                            @enderror" name="customerName" placeholder="Customer Name" value="{{ old('customerName') }}">
                                            @error('customerName')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="customerBalance" placeholder="Customer Balance">
                                            </div>
