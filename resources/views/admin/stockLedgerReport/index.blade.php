                            ...
                            <form action="#" method="POST">
                                <div class="form-group ml-5">
                                    <div class="row">
                                        ...
                                        <select class="form-control ml-3 col select2 subcategory_records"
                                            name="subCategoryName" id="subCategoryName" style="width:150px">
                                        ...
                                        <table id="" class="table table-striped table-bordered ">
                                            <thead>
                                                <a class="btn btn-success mb-3" target="blank" id="printBtn"
                                                    href="{{ url('authorized/stockLedgerInvoice/') }}" role="button"><i
            ...
            if (catID) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            output += '<option value="' + data[i].subCategoryName + '" id="' + data[i]
                                .id + '">' + data[i].subCategoryName + '</option>';
                        }
